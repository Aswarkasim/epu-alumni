...
class Lowongan extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $lowongan = $this->Crud_model->listingOneAll('tbl_lowongan', 'id_alumni', $id_alumni);
    $data = [
      'title'    => 'List Lowongan',
      'add'    => 'user/lowongan/add',
      'edit'    => 'user/lowongan/edit/',
      'lowongan'   => $lowongan,
      'content'  => 'user/lowongan/index'
    ];
