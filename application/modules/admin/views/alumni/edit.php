                ...
                <input class="form-control" name="id_alumni" placeholder="NIM" type="text" value="<?php ?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="angkatan" placeholder="Angkatan" type="number" value="<?= $alumni->angkatan ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="tahun_lulus" placeholder="Tahun Lulus" type="number" value="<?= $alumni->tahun_lulus ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="masa_tunggu" placeholder="Masa Tunggu" type="number" value="<?= $alumni->masa_tunggu ?>">
                            </div>
                        </div>
                    </div>
